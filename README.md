...
5. App.modules - Hosts all imported modules nessasary for app functionality.
...
3. Admin Tools - Update User Roles
...
4. Admin Tools - Create and Update Groups and Channels
